...
<div class="Pay_big">
        ...
        <div class="input-information">
            ...
            <div class="choose">   
                ...
                <div class="clear">
                    ...
                    <label for="sendOther">Nhập thông tin giao hàng mới</label>
                </div>
            </div>
    ...
    <?php } ?>
                ...
                <div class="payment-method">
                    ...
                    <label><input type="radio" name="payment_method" value="Momo"> Thanh toán trực tuyến</label>
                    <label><input type="radio" name="payment_method" value="VNPay"> Chuyển khoản</label>
                </div>

                <div id="Momo-fields" class="credit-details">
                    ...
                    <div class="bank-info">
                        ...
                        <p><strong>Chủ tài khoản:</strong> Nguyễn Bé Iu</p>
                    </div>

                    <div class="qr-box">
                        <img src="../public/assets/Img/vnpay-qr.png" alt="QR Code" />
                    </div>
                    </div>
                    ...
                    <div class="subtotal">
                        <div class="total">
                            ...
                            <div class="total-sum">
                                <div>Tổng cộng</div>
                                <div class="price"><?= number_format($total_cost, 0, '.', '.') ?> VNĐ</div>
                            </div>
                        </div>
                    </div>
