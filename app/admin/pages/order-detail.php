...
<body>
    ...
    <?php 
        ...
        // SỬA TẠI ĐÂY: Chỉ hiện Đã hủy khi status là COMPLETED và tiền là 0
        if ($os == 'COMPLETED' && $amount == 0) {
            echo '<span style="color:#d32f2f; font-weight:bold;">ĐÃ HỦY</span>';
        } else {
            // Các trường hợp khác hiện theo status bình thường
            switch($os) {
                case 'PENDING': echo '<span style="color:blue;">Chờ xử lý</span>'; break;
