...
$sql = "SELECT p.product_id, p.name, p.selling_price, p.image, p.current_stock, cd.quantity
        FROM cart_detail cd
    ...
    <span class="infor">
        ...
        <p class="bottom-text">SL
            ...
            <input type="number"
                ...
                data-stock="<?= $row["current_stock"] ?? 0 ?>"
...
<div class="cart-footer">
    ...
    <span class="total-amount"><?= number_format($total_price, 0, ",", ".") ?> VNĐ</span>
</div>